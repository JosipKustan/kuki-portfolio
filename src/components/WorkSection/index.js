...
const images = [
  ...
  {
    original: `https://res.cloudinary.com/josip-kuki/image/upload/${cloudinaryImgProps}/v1618090220/DioramaRastovac_kxgmt5.jpg`,
    thumbnail:
  ...
  {
    original: `https://res.cloudinary.com/josip-kuki/image/upload/${cloudinaryImgProps}/v1618090216/RastovacPainting_vcl9qe.jpg`,
    thumbnail:
      "https://res.cloudinary.com/josip-kuki/image/upload/v1618090214/RastovacPainting_thumbnail_viojql.jpg",
  },

  {
    original: `https://res.cloudinary.com/josip-kuki/image/upload/${cloudinaryImgProps}/v1618090218/Mushroom3_fv8dro.jpg`,
    thumbnail:
